...
{
    public class JavaState : StateType
    {
        internal JavaState() : this("NewState")
        { 
        
        }
        internal JavaState(string name) : base(name)
        {
        }
        ...
        public override AccessModifier DefaultAccess => base.DefaultAccess;
        ...
        {
            JavaState newState = new JavaState();
